...
Plugin URI: https://github.com/atozsites/image-alt-text
Description: Check for missing alternative text on uploaded images.
Author: atozsites
Version: 1.0
Author URI: https://github.com/atozsites/image-alt-text
*/

/******************** PLUGIN FUNCTIONS BEGIN ********************/
add_action('admin_menu', 'atozsites_image_alt_text_menu');

function atozsites_image_alt_text_menu() {
	add_options_page( 'atozsites Image Alt Text', 'Image Alt Text', 'manage_options', 'atozsites_image_alt_text', 'atozsites_image_alt_text_options' );
}

function atozsites_image_alt_text_options() { ?>
	<?php
	...
	?>
	<div id="=atozsites_image_alt_text_options" class="wrap">
		<h2>atozsites Image Alt Text</h2>
